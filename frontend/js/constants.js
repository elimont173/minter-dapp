const contractAddress = "0x71b13F61E084ccA4E8Bc32C942fF6EF088f684C6"; //Replace with your own contract address
const chain = 'polygon'; // rinkeby or polygon

const welcome_h1 = "Welcome to the JeepersNFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'Jeepers is a new and upcoming NFT. We are dedicated to creating a community in the real world along with utility and function in the growing NFT and Blockchain environment. We are working with programmers and developers to bring another level to the NFT world. Read more on our Roadmap and in the things to come section.';
